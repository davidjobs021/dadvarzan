...
$(document).ready(function(){
    ...
    $('#open-more-info').on( "click", function() {
                ...
                $("#home-wrap").toggleClass("hide-right");
        ...
        $('.command-info-wrap').toggleClass('show-command');
         $('.mCSB_scrollTools').toggleClass('mCSB_scrollTools-right');
    ...
    $('.to-close').on( "click", function() {
                ...
                $("#home-wrap").removeClass("hide-right");
		...
		var openPhotoSwipe = function(index, galleryElement, disableAnimation, fromURL) {
			...
			options = {
				...
				shareButtons: [
					...
					{id:'download', label:'دریافت تصویر', url:'{{raw_image_url}}', download:true}
				]
