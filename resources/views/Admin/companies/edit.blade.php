                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                @foreach($companies as $company)
                                    <form action="{{route(request()->segment(2).'.update', $company->id)}}" method="POST">
                                        <div class="row row-sm">
                                            {{csrf_field()}}
                                            {{ method_field('PATCH') }}
...
{{--                                                @include('error')--}}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title" id="title" value="{{$company->title}}"  class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">شماره تلفن موسسه/شرکت</p>
                                                    <input type="text" name="tel" id="tel"  value="{{$company->tel}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">شماره تلفن2</p>
                                                    <input type="text" name="tel2" id="tel2"  value="{{$company->tel2}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">شماره نمابر موسسه/شرکت</p>
                                                    <input type="text" name="tel3" id="tel3"  value="{{$company->tel3}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="meli_code" id="meli_code"  value="{{$company->meli_code}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">کد اقتصادی موسسه/شرکت</p>
                                                    <input type="text" name="eghtesadi_code" id="eghtesadi_code"  value="{{$company->eghtesadi_code}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">تاریخ ثبت موسسه/شرکت</p>
                                                    <input type="text" name="date_sabt" id="date_sabt"  value="{{$company->date_sabt}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">پیج اینستاگرام موسسه/شرکت</p>
                                                    <input type="text" name="insta" id="insta"  value="{{$company->insta}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <p class="mg-b-10">کانال تلگرام موسسه/شرکت</p>
                                                    <input type="text" name="telegram" id="telegram"  value="{{$company->telegram}}" class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="linkedin" id="linkedin" value="{{$company->linkedin}}"  class="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="address" id="address" cols="30" rows="9" class="form-control">{{$company->address}}</textarea>
                                                </div>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function(){
            jQuery('#submit').click(function(e){
                ...
                jQuery.ajax({
                    url: "{{ route(request()->segment(2).'.update' , $company->id) }}",
                    method: 'PATCH',
                    data: {
