...
{{--                                <h4 class="fs-20 font-weight-semi-bold">طرح کسب و کار</h4>--}}
                            ...
                            <ul class="generic-list-item">
                                <li><i class="la la-check text-success mr-2"></i>مشاوره رایگان</li>
                                <li><i class="la la-check text-success mr-2"></i>نیاز سنجی دقیق</li>
                                <li><i class="la la-check text-success mr-2"></i>طراحی اختصاصی</li>
                                <li><i class="la la-check text-success mr-2"></i>طراحی هویت بصری اختصاصی</li>
                                <li><i class="la la-check text-success mr-2"></i>ارائه ی طرح به صورت لایه باز</li>
                                <li><i class="la la-check text-success mr-2"></i>امکان ثبت طرح و برند</li>
                                <li><i class="la la-check text-success mr-2"></i>پشتیبانی پس از فروش</li>
                                <li><i class="la la-check text-success mr-2"></i>گارانتی خدمات</li>
                                <li><i class="la la-check text-success mr-2"></i>بدون هزینه های پنهان</li>
                            </ul>
                            <div class="price-btn-box pt-30px">
                                <a href="#" class="btn theme-btn w-100">برای ثبت سفارش کلیک کنید</a>
                            </div>
...
{{--                                <h4 class="fs-20 font-weight-semi-bold">طرح حق بیمه</h4>--}}
                            ...
                            <ul class="generic-list-item">
                                <li><i class="la la-check text-success mr-2"></i>مشاوره طراحی و اجرا</li>
                                <li><i class="la la-check text-success mr-2"></i>ثبت آنلاین تمامی مراحل</li>
                                <li><i class="la la-check text-success mr-2"></i>چاپ افست عمومی</li>
                                <li><i class="la la-check text-success mr-2"></i>چاپ افست اختصاصی</li>
                                <li><i class="la la-check text-success mr-2"></i>چاپ دیجیتال با کیفیت</li>
                                <li><i class="la la-check text-success mr-2"></i>نظارت بر چاپ اختصاصی</li>
                                <li><i class="la la-check text-success mr-2"></i>ارسال رایگان در تهران</li>
                                <li><i class="la la-check text-success mr-2"></i>تحویل سریع</li>
                                <li><i class="la la-check text-success mr-2"></i>پشتیبانی رایگان</li>
                                <li><i class="la la-check text-success mr-2"></i>بدون هزینه های پنهان</li>
                            </ul>
                            <div class="price-btn-box pt-30px">
                                <a href="#" class="btn theme-btn w-100">برای ثبت سفارش کلیک کنید</a>
