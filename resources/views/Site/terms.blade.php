        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <div class="card card-item">
                        <div class="card-body">
                            <h2 class="card-title fs-18 pb-2">1. به قالب آموزشی  خوش آمدید</h2>
                            <div class="divider"><span></span></div>
                            <p class="pb-3 text-black">این شرایط و ضوابط قوانین و مقررات استفاده از  قالب آموزشی را تشریح می کند</p>
                            <p>
