                        ...
                        <div class="card-body">
                            ...
                            <form method="post" class="pt-4">
                                <div class="d-flex flex-wrap align-items-center pb-4">
                                    <a href="{{url('login/google')}}" class="btn theme-btn flex-grow-1 mx-2 mb-2"><i class="la la-google mr-2"></i>گوگل</a>
                                    <a href="{{url('login/yahoo')}}" class="btn theme-btn flex-grow-1 mx-2 mb-2 yahoo-bg"><i class="la la-yahoo mr-2"></i>یاهو</a>
